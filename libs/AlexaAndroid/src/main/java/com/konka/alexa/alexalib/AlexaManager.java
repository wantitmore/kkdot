...
import com.konka.alexa.alexalib.interfaces.GenericSendEvent;
...
import com.konka.alexa.alexalib.interfaces.speechrecognizer.SpeechSendAudio;
import com.konka.alexa.alexalib.interfaces.speechrecognizer.SpeechSendText;
import com.konka.alexa.alexalib.interfaces.speechrecognizer.SpeechSendVoice;
...
import static com.konka.alexa.alexalib.AuthorizationManager.createCodeVerifier;
import static com.konka.alexa.alexalib.interfaces.response.ResponseParser.getBoundary;
import static com.konka.alexa.alexalib.utility.Util.IDENTIFIER;
...
//    ExecutorService pool = Executors.newFixedThreadPool(Integer.MAX_VALUE);
    ...
    /**
     * Send a synchronize state {@link Event} request to Alexa Servers to retrieve pending {@link com.konka.alexa.alexalib.data.Directive}
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param volume volume as reported by the {@link com.konka.alexa.alexalib.interfaces.speaker.AvsAdjustVolumeItem} Directive
     ...
     * See: {@link #sendEvent(String, AsyncCallback)}
     *
     * @param isMute mute state as reported by the {@link com.konka.alexa.alexalib.interfaces.speaker.AvsSetMuteItem} Directive
     * @param callback
     */
    ...
    /**
     * Send a generic event to the AVS server, this is generated using {@link com.konka.alexa.alexalib.data.Event.Builder}
