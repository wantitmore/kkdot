...
public abstract class SendEvent {
     ...
     * @param url the URL we're posting to, this is either the default {@link com.konka.alexa.alexalib.data.Directive} or {@link com.konka.alexa.alexalib.data.Event} URL
     * @param accessToken the access token of the user who has given consent to the app
     */
    protected void prepareConnection(AvsItem item, String url, String accessToken) {
    ...
    /**
     * Get our JSON {@link com.konka.alexa.alexalib.data.Event} for this call
     * @return the JSON representation of the {@link com.konka.alexa.alexalib.data.Event}
     */
    @NotNull
    protected abstract String getEvent(AvsItem item);
